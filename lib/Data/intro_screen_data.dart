...
final Set<WelcomeScreenModel> introElements = {
  WelcomeScreenModel(
    ...
    subtitle: 'Discover the best foods over 1000 restaurants and fast delivery to your home',
    image: Image.asset('Assets/images/page_view_1.png'),
  ),
 
  WelcomeScreenModel(
    title: 'Live Tracking',
    subtitle: 'Real time tracking of your food on the map, so you know where it is at all times',
